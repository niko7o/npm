function changeAcronym(){
  ...
  acronym.innerHTML = namelist[Math.floor(Math.random() * namelist.length)]; // we use the array's length so that our Math.random maximum won't have to be updated in the future even if we add more names
