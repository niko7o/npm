function changeAcronym(){
  var namelist = ['Never Push to Master','Neil Patricks Mansion','No Princess Mario',
  'Nothing Prevents Misery','Node Package Manager','Naughty Push Message',
  'Never Program Mad','Nineties Party Mix','Neverending Plethora of Modules'];
